...
PATH_MAP = {'styles_krea2_mega_plus_v6_literal_triggers.csv': 'csv/styles/novoloko_krea2_styles_1455.csv', 'characters_krea2_nova_v3_expanded_real_female.csv': 'csv/characters/novoloko_characters_master_3200.csv', 'characters_real_female_fixed.csv': 'csv/characters/novoloko_characters_master_3200.csv', 'Characters_Master_Uncensored.csv': 'csv/characters/novoloko_characters_master_3200.csv', 'xxxxpose.csv': 'csv/poses/novoloko_poses_1500.csv', 'csv/actions/nova_actions_1000.csv': 'csv/actions/novoloko_actions_1500.csv', 'csv/clothing/nova_branded_clothing_1000.csv': 'csv/clothing/novoloko_clothing_hair_expanded_5800.csv', 'csv/clothing/nova_branded_clothing_gendered_2400.csv': 'csv/clothing/novoloko_clothing_hair_expanded_5800.csv', 'csv/clothing/nova_clothing_hair_expanded_4000.csv': 'csv/clothing/novoloko_clothing_hair_expanded_5800.csv', 'csv/locations/nova_locations_expanded_3000.csv': 'csv/locations/novoloko_locations_expanded_global_3846.csv', 'csv/locations/nova_real_locations_1000.csv': 'csv/locations/novoloko_real_locations_global_1315.csv', 'csv/mega/nova_mega_mix_4000.csv': 'csv/mega/novoloko_mega_mix_10000.csv', 'csv/mega/nova_mega_mix_5400.csv': 'csv/mega/novoloko_mega_mix_10000.csv', 'csv/mega/nova_mega_mix_9000.csv': 'csv/mega/novoloko_mega_mix_10000.csv', 'csv/poses/nova_poses_1000.csv': 'csv/poses/novoloko_poses_1500.csv', 'styles/nova_all_yaml_styles.yaml': 'styles/novoloko_all_yaml_styles.yaml', 'styles/more examples/Pixaroma.yaml': 'styles/more examples/Mediums.yaml'}

...
class RepositoryTests(unittest.TestCase):
    def test_manifest_brand_and_package(self) -> None:
        manifest = json.loads((ROOT / "NovoLoko_v3.9.3_manifest.json").read_text(encoding="utf-8"))
    ...
    def test_v393_workflow_has_clean_visible_text_and_no_personal_runtime_state(self) -> None:
        path = ROOT / "workflows/NovoLoko AIO v3.9.3 - Latest Workflow.json"
